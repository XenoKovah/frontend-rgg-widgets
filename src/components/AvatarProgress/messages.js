...
const messages = defineMessages({
  'rgg.avatar.progress.alert.fully.developed.message': {
    ...
    defaultMessage: 'Congratulations, your avatar is fully developed! You can choose a different avatar on the <link>Performance page</link>;'
    + ' your accumulated points and the latest evolution you unlocked will be preserved.',
